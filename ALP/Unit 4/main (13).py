...
print(str(num1) + " times " + str(num2) + " = " + str(total2))

# Instructions

# Line 4 creates an error. Look carefully to see what is wrong with the code and fix it.
# data from the input() function is by default in string form, so even if you enter an integer or a number, python treats it like a piece of text
